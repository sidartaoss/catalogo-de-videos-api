...
public class CategoryController implements CategoryAPI {
    ...
    @Override
    public ResponseEntity<?> createCategory(final CreateCategoryRequest aRequest) {
        final var aCommand = CreateCategoryCommand.with(
                aRequest.name(),
                aRequest.description(),
                aRequest.active() != null ? aRequest.active() : true);
    ...
    @Override
    public ResponseEntity<?> updateById(final String id, final UpdateCategoryRequest aRequest) {
